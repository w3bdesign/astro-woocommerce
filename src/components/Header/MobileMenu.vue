    ...
    >
      <ul>
        <li class="text-xl linkStyle">
          <a href="/" @click="displayMobileMenu"> Home </a>
        </li>
        <li class="text-xl linkStyle">
          <a href="/products" @click="displayMobileMenu"> Products </a>
        </li>
        <li class="text-xl linkStyle">
          <a href="/categories" @click="displayMobileMenu"> Categories </a>
        </li>
        <li class="text-xl linkStyle">
          <a href="/search" @click="displayMobileMenu"> Search </a>
        </li>
